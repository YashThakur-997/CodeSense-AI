  ...
  return (
    ...
    >
      ...
      <motion.span
        ...
        className="text-neutral-400 dark:text-neutral-400 text-sm group-hover/sidebar:translate-x-1 group-hover/sidebar:text-white transition duration-150 whitespace-pre inline-block p-0! m-0!"
      >
        {link.label}
      </motion.span>
    </a>
